...
Then, build Whisper, by running the commands shown below. This will be much faster as nothing is compiled, the base image conveniently comes with [pre-compiled executables :smiley:][^6]
...
[^6]: https://github.com/ggml-org/whisper.cpp?tab=readme-ov-file#docker
